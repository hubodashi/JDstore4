...
Product.create!(title: "春季2017新款薄韩版牛仔夹克",
              description: "新品推荐",
              price: 128,
              quantity: 1000,
...
Product.create!(title: "男士大码型男装夹克",
...
Product.create!(title: "春秋季男士长袖牛仔衬衫",
              description: "韩版修身款",
              price: 120,
              quantity: 1000,
...
Product.create!(title: "2017春季热卖牛仔裤",
                description: "中腰牛仔裤",
                price: 158,
                quantity: 300,
...
Product.create!(title: "SELECTED思莱德夏季新款男牛仔裤",
...
Product.create!(title: "西部牛仔男靴英伦马丁靴",
...
Product.create!(title: "2017夏季低帮百搭休闲板鞋",
...
# 运动系列
# 运动套装
Product.create!(title: "男运动套装夏季无袖背心短裤",
...
Product.create!(title: "2017新款运动棉麻男士套装",
               description: "休闲薄款",
               price: 199,
               quantity: 50,
...
Product.create!(title: "Kappa卡帕男款运动套装",
...
#  运动上衣
Product.create!(title: "三叶草 男 短袖上衣",
...
Product.create!(title: "KELME卡尔美夏季新款运动T恤",
                description: "透气速干",
                price: 239,
                quantity:20,
...
Product.create!(title: "Markless风衣",
...
Product.create!(title: "男士卫衣春季2017新款",
...
Product.create!(title: "PUMA彪马七分裤",
                description: "透气收口小脚",
                price: 249,
                quantity:50,
...
Product.create!(title: "GXG 春装新款黑色束脚裤子",
                description: "运动针织裤",
                price: 269,
                quantity:10,
...
Product.create!(title: "NIKE COURT LITE 男子网球运动鞋",
...
Product.create!(title: "adidas跑步鞋",
...
Product.create!(title: "Massimo Dutti时尚西装",
              description: "修身款",
              price: 1590,
              quantity: 5,
...
Product.create!(title: "雅戈尔男士短袖衬衫",
...
Product.create!(title: "柒牌长袖衬衫2017春季新款",
...
Product.create!(title: "G2000商务男装纯色长袖衬衫",
...
# 领带+腰带
Product.create!(title: "[预售]Calvin Klein男士商务休闲领带",
            description: "海外直供",
            price: 599,
            quantity: 5,
...
Product.create!(title: "GUCCI男士新款单圈腰带",
...
Product.create!(title: "Brooks Brothers B2008R男经典款条纹领带",
...
Product.create!(title: "报喜鸟新款高端男士印花领结",
...
Product.create!(title: "GXG新品男士时尚英伦牛皮系",
...
Product.create!(title: "clarks正装男鞋",
...
Product.create!(title: "金利来夏季男士商务正装皮鞋",
